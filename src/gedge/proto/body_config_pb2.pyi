...
class BodyConfig(_message.Message):
    ...
    body: _containers.MessageMap[str, _data_model_config_pb2.DataObjectConfig]
    def __init__(self, body: _Optional[_Mapping[str, _data_model_config_pb2.DataObjectConfig]] = ...) -> None: ...
