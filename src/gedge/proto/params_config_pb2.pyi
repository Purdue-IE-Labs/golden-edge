...
class ParamsConfig(_message.Message):
    ...
    params: _containers.MessageMap[str, _data_object_config_pb2.DataObjectConfig]
    def __init__(self, params: _Optional[_Mapping[str, _data_object_config_pb2.DataObjectConfig]] = ...) -> None: ...
