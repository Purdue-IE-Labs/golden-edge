...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_META_TAG']._serialized_end=321
  _globals['_META_TAG_PROPERTIESENTRY']._serialized_start=261
  _globals['_META_TAG_PROPERTIESENTRY']._serialized_end=321
