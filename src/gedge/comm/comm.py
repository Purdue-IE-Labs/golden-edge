...
>>>>>>> fcfac7a3fc8359949a553401fcff96be1a3c86a8
...
>>>>>>> fcfac7a3fc8359949a553401fcff96be1a3c86a8
        ...
        Returns:
            zenoh.LivelinessToken: A token representing the online state of the passed node
        '''
...
>>>>>>> fcfac7a3fc8359949a553401fcff96be1a3c86a8
    ...
    def _query_sync(self, key_expr: str, payload: bytes) -> zenoh.Reply:
        ...
        Returns:
            zenoh.Reply: The reply sent from Zenoh
        '''
        try:
...
>>>>>>> fcfac7a3fc8359949a553401fcff96be1a3c86a8
    ...
    def write_tag(self, ks: NodeKeySpace, path: str, value: proto.TagData) -> proto.WriteResponseData:
        ...
        Returns:
            proto.WriteResponseData: The deserealized write respose data passed from the Zenoh reply
        '''
    ...
    def pull_meta_message(self, ks: NodeKeySpace) -> proto.Meta:
        ...
        Returns:
            proto.Meta: The pulled proto messages from the current Zenoh session
        '''
        try:
