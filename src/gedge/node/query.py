...
# from gedge.node.method import Response
from gedge.proto.method_pb2 import ResponseData
from gedge import proto

class Query:
    def __init__(self, ks: NodeKeySpace, path: str, comm: Comm, query: zenoh.Query, parameters: dict[str, Any] = {}, responses: list = []):
        self.path = path
        self._ks = ks
        self._comm = comm
        self._query = query
    ...
    def reply(self, code: int, body: dict[str, Any], error: str = ""):
        ...
        r = ResponseData(code=code, error=error, body=new_body)
